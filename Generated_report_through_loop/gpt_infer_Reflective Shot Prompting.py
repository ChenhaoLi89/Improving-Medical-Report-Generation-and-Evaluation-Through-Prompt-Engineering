...
question_list = ["1.Trachea and Main Bronchi - Assessment for patency (openness) and any occlusive pathology.",
                ...
                "15.Hiatal Hernia - If present, its description is included."]
question_txt = ""
for x in range(15):
    question_txt = question_txt + question_list[x] + "\n" 
...
for i in tqdm(range(4,-1,-1)):
    ...
    generated_report = gpt4o(conversation)
    ...
    if i == 0:
        ...
        for j in range(200):
            ...
            save_folder = "./Baseline_result_gqa_gpt_combine_large_common/llama_infer"+str(5-i)+"/" 
            path = image_url
